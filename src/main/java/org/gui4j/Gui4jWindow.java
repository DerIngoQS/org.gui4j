...
public interface Gui4jWindow {
  ...
  /**
   * Display the working cursor. A counter variable remembers the the number of calls of
   * setWorkingCursor and setNormalCursor, so that only the last call of setNormalCursor really
  ...
  /**
   * @param busy if true, then the wait cursor will be shown the the gui will be blocked. A counter
   *     variable remembers the number of calls with busy true and false and the last call of
   *     setBusy(false) will unlock the gui and the normal cursor will be displayed.
   */
