 ...
 * depends only on a given resource name and a given controller class. Additionally, the same
 * instance of a Gui4jComponent might be used for several Swing instances. On the other side, there
 * is always one instance of Gui4jComponentInstance for each Swing instance.
 */
public final class Gui4jComponentInstance {
  ...
  public Gui4jComponentInstance getGui4jComponentInstance(Gui4jQualifiedComponent path) {
    return mGui4jSwingContainer.getGui4jComponentInstance(
        mGui4jComponentInPath.getGui4jComponentPath(), path);
  }
