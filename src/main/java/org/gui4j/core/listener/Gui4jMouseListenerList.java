 ...
 */
public final class Gui4jMouseListenerList extends Gui4jMouseListener
   ...
   * @param model
   */
  public Gui4jMouseListenerList(
      Gui4jComponentInstance gui4jComponentInstance, InternalElementRetriever model) {
