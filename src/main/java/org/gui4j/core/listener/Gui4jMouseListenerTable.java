 ...
 */
public final class Gui4jMouseListenerTable
    implements MouseListener, ListSelectionListener, Gui4jDispose {
   ...
   * @param action
   */
  public Gui4jMouseListenerTable(
  ...
  private void performWork() {
    ...
    Gui4jCall work = getGui4jCall(paramMap);
    if (work != null) {
