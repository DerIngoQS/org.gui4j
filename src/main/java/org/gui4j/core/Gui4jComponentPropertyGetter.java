...
public final class Gui4jComponentPropertyGetter implements ErrorTags, Gui4jComponentProperty {
  ...
  public Gui4jComponentPropertyGetter(
      Gui4jCall gui4jAccess, MethodCall method, boolean useSwingComponent) {
      ...
      if (SwingUtilities.isEventDispatchThread()) {
        ...
        try {
          ...
          Gui4jThreadManager gui4jThreadManager =
              gui4jComponentInstance.getGui4j().getGui4jThreadManager();
