...
public class BooleanTableCellRenderer extends JCheckBox implements TableCellRenderer {
  ...
  /**
   * This method returns the background color to use for an unselected table cell. This method is
   * provided for custom swing UI delegates that need to know the original background color, e.g.
   * for rendering the checkbox icon independently from the cell being selected or not.
   *
