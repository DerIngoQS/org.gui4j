...
/**
 * A normal JPanel with the added possibility to optionally set a background image. The image will
 * be scaled to match the current size of the panel.
 */
public class JPanelImage extends JPanel {
   ...
   * Constructor.
   *
   * @param img The background image. If it is <code>null</code>, this JPanelImage will behave like
   *     a normal JPanel.
   */
