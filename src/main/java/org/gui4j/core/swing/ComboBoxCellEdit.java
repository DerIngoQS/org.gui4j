...
public class ComboBoxCellEdit extends DefaultCellEditor {
  ...
  private ComboBoxCellEdit(
    ...
    final TransformValue transformValue =
        new TransformValue() {
    ...
    DefaultListCellRenderer cellRenderer =
        new DefaultListCellRenderer() {
          public Component getListCellRendererComponent(
              JList list, Object pValue, int index, boolean isSelected, boolean cellHasFocus) {
            return super.getListCellRendererComponent(
                list, transformValue.transform(pValue), index, isSelected, cellHasFocus);
          }
        };
  ...
  public final class ComboBoxCellEditFocus extends BasicComboBoxEditor {
    ...
    public void setItem(Object anObject) {
      ...
      if ((anObject != null)
          && (mParamMap != null)
          && !(String.class.isAssignableFrom(anObject.getClass()))) {
