...
public class Gui4jCellEditor extends DefaultCellEditor {
  ...
  public void setNotificationCallback(
      Gui4jCallBase gui4jController, Gui4jCall notifyTempValue, Map params, Object paramsValueKey) {
  ...
  /**
   * Method called by an edit component to notify the cell editor about the current temporary
   * (non-committed) value of the editing component.
   *
   * @param value
   */
   ...
   * @param textField
   */
  private Gui4jCellEditor(JTextField textField) {
    super(textField);
  }
