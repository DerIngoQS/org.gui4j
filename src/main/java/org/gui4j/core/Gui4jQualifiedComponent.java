...
public class Gui4jQualifiedComponent implements Serializable {
  ...
  public Gui4jQualifiedComponent(
      Gui4jComponentContainerInclude include, Gui4jComponent gui4jComponent) {
    this(new Gui4jComponentPath(include), gui4jComponent);
  }

  public Gui4jQualifiedComponent(
      Gui4jComponentContainerInclude include, Gui4jQualifiedComponent path) {
    this(new Gui4jComponentPath(include), path);
  }

  public Gui4jQualifiedComponent(
      Gui4jComponentPath gui4jComponentPath, Gui4jComponent gui4jComponent) {
  ...
  public String toString() {
    return Extract.getClassname(getClass())
        + "["
        + getGui4jComponentPath()
        + ","
        + mGui4jComponent
        + "]";
  }
