...
/**
 * This class represents a base for all user-defined implementations of Gui4jComponent. It
...
public abstract class Gui4jAbstractComponent implements ErrorTags, Gui4jComponent, Serializable {
   ...
   * @param id the identifier of this instance in the specified <code>Gui4jComponentContainer</code>
   *     (might be <code>null</code>).
   */
  public Gui4jAbstractComponent(
      Gui4jComponentContainer gui4jComponentContainer, Class componentClass, String id) {
    mId = id;
  ...
  protected void setProperties(Gui4jComponentInstance gui4jComponentInstance) {
    ...
    if (mApply != null) {
      mApply.getValueUseDefaultParam(
          gui4jComponentInstance.getGui4jCallBase(), gui4jComponentInstance.getComponent(), null);
    }
  }
   ...
   */
  private Gui4jMouseListener initMouseListener(
      Gui4jComponentInstance gui4jComponentInstance, Gui4jMouseListener listener) {
    if (listener == null) {
  ...
  public Gui4jComponentProperty[] getGui4jComponentProperties() {
    if (mGui4jComponentPropertyList.size() > 0) {
      Gui4jComponentProperty[] props =
          new Gui4jComponentProperty[mGui4jComponentPropertyList.size()];
  ...
  public void definePropertySetter(String propertyName, Gui4jCall gui4jAccess, boolean useContext) {
    if (gui4jAccess != null) {
      ...
      try {
        ...
        addGui4jComponentProperty(
            new Gui4jComponentPropertySetter(gui4jAccess, m, usesSwingComponent, useContext));
  ...
  public void definePropertyGetter(String propertyName, Gui4jCall gui4jAccess) {
    if (gui4jAccess != null) {
      ...
      try {
        ...
        if (resultType != null
            && argumentType != null
            && argumentType.isAssignableFrom(resultType)) {
          addGui4jComponentProperty(
              new Gui4jComponentPropertyGetter(gui4jAccess, m, usesSwingComponent));
        } else {
          Object[] eArgs = {propertyName, resultType, argumentType};
          throw new Gui4jUncheckedException.ResourceError(
              getConfigurationName(), -1, RESOURCE_ERROR_property_getter_type_incompatible, eArgs);
        }
      } catch (Gui4jUncheckedException e) {
        mLogger.error(e);
      }
   ...
   */
  protected void applyInitialProperties(
   ...
   */
  public final Gui4jComponentInstance createGui4jComponentInstance(
      Gui4jSwingContainer gui4jSwingContainer,
      Gui4jCallBase gui4jCallBase,
    ...
    applyInitialProperties(
        gui4jComponentInstance, gui4jComponentInstance.getGui4jCallBase(), false);
   ...
   * @return Gui4jComponentInstance
   */
  protected abstract Gui4jComponentInstance createComponentInstance(
      Gui4jSwingContainer gui4jSwingContainer,
      Gui4jCallBase gui4jCallBase,
      Gui4jQualifiedComponent gui4jComponentInPath);
  ...
  /**
   * Gui4jComponents should override this method if they want to supply a context object to its
   * popup menu.
   *
   * @param gui4jComponentInstance
  ...
  /**
   * Defines location of popup menu. Gui4jComponents should override this method to tune the
   * location behaviour (especially for defining meaningful locations also for non-mouse-triggered
   * popups, i.e. keyboard).
   *
   * @param gui4jComponentInstance
  ...
  public void handleSuccess(Gui4jComponentInstance gui4jComponentInstance) {
    gui4jComponentInstance
        .getGui4j()
        .handleSuccess(
            gui4jComponentInstance.getGui4jCallBase(), gui4jComponentInstance.getContext());
  }
  ...
  public void handleException(Gui4jComponentInstance gui4jComponentInstance, Throwable t) {
    gui4jComponentInstance
        .getGui4j()
        .handleException(
            gui4jComponentInstance.getGui4jCallBase(), t, gui4jComponentInstance.getContext());
  }
