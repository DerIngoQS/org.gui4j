...
public interface Gui4jComponent {
   ...
   * resolved for a given controller class. This means that several views of the same resource file
   * share the same instance of the corresponding Gui4jComponent. This is important, because the
   * Gui4jComponent instance must not contain any information dependant on a given swing instance.
   */
   ...
   *
   * @param gui4jComponentInstance
   * @param mouseEvent das mouse event, falls PopUp durch Mausaktion gefordert wurde, <code>null
   *     </code> falls nicht (z.B. durch Tastatur)
   */
