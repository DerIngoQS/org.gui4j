...
/**
 * Contains the Gui4jComponent instances for a given resource file resolved for a given controller
 * class type
 */
public interface Gui4jComponentContainer {
   ...
   * @param e
   * @param field
   * @return the attribute value of the field <code>field</code> where occuring macros are
   ...
   * @param field
   * @return the attribute value of the field <code>field</code> where occuring macros are
   *     substituted by their definitions (macros my also occur inside a string)
   */
  public String getAttrValueReplaceAll(LElement e, String field);

  /**
   * @param field
   * @return the attribute value of <code>field</code> of the topmost element of the resource.
   */
  ...
  /**
   * Liefert die Menge der Ids zurück welche durch Parameterinstanziierung benötigt werden
   *
   * @return Set
   */
  Set getMappedIds();
  ...
  // public List getGui4jComponentContainerIncludePath(Gui4jComponentContainer
