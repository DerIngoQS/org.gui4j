 ...
 * Whenever an instance of Gui4jComponentContainer for a given resource file and given controller
 * class type is requested, the Gui4jComponentManager creates that instance or returns an already
...
public final class Gui4jComponentContainerManager implements Serializable, ErrorTags {
  ...
  /**
   * If a <code>Gui4jComponentContainer</code> for the specified combination is already loaded, then
   * it is returned. Otherwise, a new instance is created. Note that one instance of <code>
   * Gui4jComponentContainer</code> might be shared by several instances of <code>
   * Gui4jSwingContainer</code>.
   *
   * @param controllerClass
   * @param resourceNameFullyQuantified
   * @return Gui4jComponentContainer
   */
  public synchronized Gui4jComponentContainer getGui4jComponentContainer(
      Class controllerClass, String resourceNameFullyQuantified) {
    mLogger.debug(
        "Resource "
    ...
    if (container == null) {
      ...
      container =
          new Gui4jComponentContainerImpl(
              mGui4j, controllerClass, resourceNameFullyQuantified, resource);
  ...
  static class Resource implements Serializable, ErrorTags {
    ...
    private void load() {
      ...
      try {
        ...
        builder.setEntityResolver(
            new EntityResolver() {
              ...
              public InputSource resolveEntity(String publicId, String systemId)
                ...
                mLogger.debug(
                    "Resolving entity for: PublicId: " + publicId + ", SystemId: " + systemId);
                if (systemId != null) {
        ...
        throw new Gui4jUncheckedException.ResourceError(
            mResourceNameFullyQualified, -1, RESOURCE_ERROR_jdom_exception, args, e);
      }
        ...
        try {
          ...
          if (name.equals(Gui4jComponentManager.ELEMENT_Gui4jStyleEnd)) {
            if (gui4jStyles.size() > 0) {
              ...
              throw new Gui4jUncheckedException.ResourceError(
                  mResourceNameFullyQualified,
                  e.getLineNumber(),
                  RESOURCE_ERROR_unexpected_gui4jStyle_end);
            }
          }
          ...
          if (name.equals(Gui4jComponentManager.ELEMENT_Gui4jStyle)) {
            ...
            for (Iterator it2 = e.elementIterator(); it2.hasNext(); ) {
              ...
              mStyleContainer.addAttributes(
                  child.getName().substring(startIdx), styleName, child.attributes());
            }
            it.remove();
          }
          if (name.equals(Gui4jComponentManager.ELEMENT_Gui4jInclude)) {
            ...
            String baseController =
                e.attributeValue(Gui4jComponentManager.FIELD_Gui4jIncludeController);
            String refreshCall = e.attributeValue(Gui4jComponentManager.FIELD_Gui4jIncludeRefresh);
            // try
            {
              String resourceIncludeName =
                  getResourceNameFullyQuantified(mResourceNameFullyQualified, includeNameRel);
              ...
              importInfo.urlLineNo =
                  getLineNumber(e.attribute(Gui4jComponentManager.FIELD_Gui4jIncludeURL));
              importInfo.controllerLineNo =
                  getLineNumber(e.attribute(Gui4jComponentManager.FIELD_Gui4jIncludeController));
              importInfo.refreshLineNo =
                  getLineNumber(e.attribute(Gui4jComponentManager.FIELD_Gui4jIncludeRefresh));
              mGui4jImportList.add(importInfo);
              Resource importResource =
                  mGui4j.getGui4jComponentContainerManager().getResource(resourceIncludeName);
              ...
              for (Iterator it2 = importClassAliasMap.entrySet().iterator(); it2.hasNext(); ) {
                ...
                insertAlias(
                    (String) importClassAliasMapResourceName.get(aliasName),
                    aliasName,
              ...
              for (Iterator it2 = importDefMap.entrySet().iterator(); it2.hasNext(); ) {
                ...
                insertDef(
                    (String) importDefMapResourceName.get(defName),
                    defName,
          ...
          if (name.equals(Gui4jComponentManager.ELEMENT_Gui4jClassAlias)) {
            ...
            try {
              ...
              throw new Gui4jUncheckedException.ResourceError(
                  mResourceNameFullyQualified,
                  e.getLineNumber(),
                  RESOURCE_ERROR_alias_class_not_found,
                  args,
                  exc);
            }
            it.remove();
    ...
    private void insertDef(String resourceName, String name, String value) {
      if (mDefMap.containsKey(name) && !resourceName.equals(mDefMapResourceName.get(name))) {
        Gui4jComponentContainerManager.mLogger.warn(
            "macro '" + name + "' already defined with value '" + mDefMap.get(name) + "'");
      } else {
    ...
    private void insertAlias(String resourceName, String aliasName, Class c) {
      if (mClassAliasMap.containsKey(aliasName)
        ...
        throw new Gui4jUncheckedException.ResourceError(
            mResourceNameFullyQualified, -1, RESOURCE_ERROR_alias_already_defined, args);
      }
  ...
  static class Gui4jComponentContainerImpl implements Serializable, Gui4jComponentContainer {
    ...
    private static final Log mLoggerComponentContainer =
        LogFactory.getLog(Gui4jComponentContainerImpl.class);

    protected Gui4jComponentContainerImpl(
        Gui4jInternal gui4j,
        Class gui4jControllerClass,
      ...
      Gui4jAbstractComponent dummyComponent =
          new Gui4jAbstractComponent(this, Object.class, "") {
      ...
      if (titleCallStr != null) {
        mTitleCall =
            parser.getInstance(dummyComponent, resource.getLineNoOfTopLevelAttrs(), titleCallStr);
      ...
      if (windowNameCallStr != null) {
        mWindowNameCall =
            parser.getInstance(
                dummyComponent, resource.getLineNoOfTopLevelAttrs(), windowNameCallStr);
      ...
      for (Iterator it = mParamIds.iterator(); it.hasNext(); ) {
        ...
        mGui4jComponentsInPath.put(
            id, new Gui4jQualifiedComponent(gui4jComponentPath, gui4jComponent));
      }
      ...
      for (int i = 0; i < importInfo.length; i++) {
        try {
          ...
          if (importInfo[i].controller != null) {
            ...
            Gui4jCall refreshCall =
                parser.getInstance(
                    dummyComponent, importInfo[i].refreshLineNo, importInfo[i].refresh);
            if (refreshCall != null) {
              ...
              mGui4j
                  ...
                  .getGui4jComponentContainer(
                      ...
                      getResourceNameFullyQuantified(
                          resourceNameFullyQuantified, importInfo[i].relName));
          for (Iterator it = gui4jComponentContainer.getParamIds().iterator(); it.hasNext(); ) {
            ...
            if (!importInfo[i].paramMap.containsKey(paramId)) {
              ...
              throw new Gui4jUncheckedException.ResourceError(
                  mRessourceNameFullyQualified, -1, RESOURCE_ERROR_unknown_param, args);
            }
          }
          for (Iterator it = importInfo[i].paramMap.keySet().iterator(); it.hasNext(); ) {
            ...
            if (!gui4jComponentContainer.getParamIds().contains(paramId)) {
              Object[] args = {paramId, gui4jComponentContainer.getConfigurationName()};
              throw new Gui4jUncheckedException.ResourceError(
                  mRessourceNameFullyQualified, -1, RESOURCE_ERROR_unknown_param_in_include, args);
            }
          }
          Gui4jComponentContainerInclude gui4jComponentContainerInclude =
              new Gui4jComponentContainerInclude(
      ...
      mLoggerComponentContainer.debug(
          "Looping through top-level definition of resource " + resourceNameFullyQuantified);
        ...
        try {
          ...
          if (id != null) {
            if (isDefined(id)) {
              Object[] args = {id};
              throw new Gui4jUncheckedException.ResourceError(
                  mRessourceNameFullyQualified,
                  e.getLineNumber(),
                  RESOURCE_ERROR_gui4jComponent_already_defined,
                  args);
            } else {
              mElements.put(id, e);
            }
    ...
    private Map computeParamInstantiation() {
      ...
      for (Iterator it = mGui4jComponentContainerImports.iterator(); it.hasNext(); ) {
        ...
        for (Iterator itInclude =
                include.getGui4jComponentContainer().getParamInstantiation().entrySet().iterator();
            itInclude.hasNext(); ) {
        ...
        for (Iterator itInclude = include.getParamMap().entrySet().iterator();
            itInclude.hasNext(); ) {
          Map.Entry entry = (Map.Entry) itInclude.next();
          String param = (String) entry.getKey();
          String id = (String) entry.getValue();
          m.put(
              new Gui4jQualifiedComponent(
                  path, include.getGui4jComponentContainer().getGui4jQualifiedComponent(param)),
              getGui4jQualifiedComponent(id));
        }
      }
      return m;
    }
    ...
    public synchronized Gui4jQualifiedComponent extractGui4jComponent(LElement e) {
      ...
      if (name.equals(Gui4jComponentManager.ELEMENT_Gui4jRef)) {
        ...
        Gui4jComponentFactory factory =
            mGui4j.getGui4jComponentManager().getGui4jComponentFactory(name);
        Gui4jComponent gui4jComponent = factory.defineBy(this, id, e);
        Gui4jQualifiedComponent gui4jComponentInPath =
            new Gui4jQualifiedComponent(new Gui4jComponentPath(), gui4jComponent);
        if (id != null) {
          if (isDefined(id)) {
            Object[] args = {id};
            throw new Gui4jUncheckedException.ResourceError(
    ...
    public synchronized Gui4jQualifiedComponent getGui4jQualifiedComponent(String id) {
      Gui4jQualifiedComponent gui4jComponentInPath =
          (Gui4jQualifiedComponent) mGui4jComponentsInPath.get(id);
      if (gui4jComponentInPath == null) {
        ...
        if (e == null) {
          ...
          if (idxSep != -1) {
            ...
            for (Iterator it = mGui4jComponentContainerImports.iterator(); it.hasNext(); ) {
              Gui4jComponentContainerInclude gui4jComponentContainerInclude =
                  (Gui4jComponentContainerInclude) it.next();
              if (gui4jComponentContainerInclude.getAliasName().equals(prefix)) {
                ...
                if (gui4jComponentContainer.isDefined(suffix)) {
                  Gui4jQualifiedComponent path =
                      gui4jComponentContainer.getGui4jQualifiedComponent(suffix);
          ...
          Object[] args = {id};
          throw new Gui4jUncheckedException.ResourceError(
              mRessourceNameFullyQualified, -1, RESOURCE_ERROR_gui4jComponent_not_defined, args);
        }
