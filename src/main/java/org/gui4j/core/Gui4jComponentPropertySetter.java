...
public final class Gui4jComponentPropertySetter
    implements ErrorTags, Gui4jComponentProperty, Serializable {
  ...
  public Gui4jComponentPropertySetter(
      Gui4jCall gui4jAccess, MethodCall method, boolean useSwingComponent, boolean useContext) {
      ...
      if (!handleThreads) {
        ...
        try {
          ...
          throw new Gui4jUncheckedException.ProgrammingError(
              PROGRAMMING_ERROR_invocation_target_exception, e);
