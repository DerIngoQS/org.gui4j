...
final class Gui4jDefaultCall implements ErrorTags, Serializable, Gui4jCall {
  ...
  Gui4jDefaultCall(
      ...
      Gui4jAccessImpl gui4jAccessImpl,
      List dependantProperties,
      Map valueClassMap) {
    this(
        gui4jComponent, gui4jAccessImpl, dependantProperties, valueClassMap, Collections.EMPTY_SET);
  }
  ...
  /**
   * @param baseInstance the root class used for reflection
   * @param defaultValue
   * @return Object
   */
  ...
  public Object getValueNoErrorChecking(
      Gui4jCallBase gui4jController, Map paramMap, Gui4jComponentInstance componentInstance) {
    return mGui4jAccessImpl.getValue(gui4jController, gui4jController, paramMap);
  }

  /**
   * @param baseInstance the root class used for reflection
   * @param defaultParamValue the value substituted for '?' in the access path
   * @param defaultValue
   * @return Object
   */
  public Object getValueUseDefaultParam(
  ...
  Object getValue(
      Gui4jCallBase gui4jController, Object thisInstance, Map paramMap, Object defaultValue) {
    try {
