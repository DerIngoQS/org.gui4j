...
public final class Gui4jTextAttribute implements Serializable {
   ...
   * @param alignment
   */
  private Gui4jTextAttribute(
      Gui4jCall foreground,
  ...
  public static Gui4jTextAttribute getInstance(
      Gui4jComponentFactory gui4jComponentFactory, Gui4jComponent gui4jComponent, LElement e) {
  ...
  public static Gui4jTextAttribute getInstance(
    ...
    Gui4jCall foreground =
        gui4jComponentFactory.getGui4jAccessInstance(
            Color.class, paramMap, gui4jComponent, e, FOREGROUND);
    Gui4jCall background =
        gui4jComponentFactory.getGui4jAccessInstance(
            Color.class, paramMap, gui4jComponent, e, BACKGROUND);
    Gui4jCall evenBackground =
        gui4jComponentFactory.getGui4jAccessInstance(
            Color.class, paramMap, gui4jComponent, e, EVEN_BACKGROUND);
    Gui4jCall font =
        gui4jComponentFactory.getGui4jAccessInstance(Font.class, paramMap, gui4jComponent, e, FONT);
    int hAlign = -1;
    {
   ...
   */
  public static Gui4jCall getCall(
      Gui4jTextAttribute gui4jTextAttribute1,
      Gui4jTextAttribute gui4jTextAttribute2,
      Gui4jTextAttribute gui4jTextAttribute3,
      Gui4jCallProvider provider) {
    Gui4jCall gui4jValue;
    if (gui4jTextAttribute1 != null
        && ((gui4jValue = provider.retrieveGui4jCall(gui4jTextAttribute1)) != null)) {
      return gui4jValue;
    }
    if (gui4jTextAttribute2 != null
        && ((gui4jValue = provider.retrieveGui4jCall(gui4jTextAttribute2)) != null)) {
      return gui4jValue;
    }
    if (gui4jTextAttribute3 != null
        && ((gui4jValue = provider.retrieveGui4jCall(gui4jTextAttribute3)) != null)) {
      return gui4jValue;
    }
    return null;
  }
  ...
  public static Color getEvenBackground(
      Gui4jCallBase gui4jController,
      Gui4jTextAttribute gui4jTextAttribute1,
      Gui4jTextAttribute gui4jTextAttribute2,
      Gui4jTextAttribute gui4jTextAttribute3) {
    ...
    Gui4jCall gui4jValue;
    if (gui4jTextAttribute1 != null
        && ((gui4jValue = gui4jTextAttribute1.mEvenBackground) != null)) {
      return (Color) gui4jValue.getValue(gui4jController, nullMap, null);
    }
    if (gui4jTextAttribute2 != null
        && ((gui4jValue = gui4jTextAttribute2.mEvenBackground) != null)) {
      return (Color) gui4jValue.getValue(gui4jController, nullMap, null);
    }
    if (gui4jTextAttribute3 != null
        && ((gui4jValue = gui4jTextAttribute3.mEvenBackground) != null)) {
      return (Color) gui4jValue.getValue(gui4jController, nullMap, null);
    }
    return null;
  }
