...
final class Gui4jValidatorImpl implements Gui4jValidator {
  ...
  public boolean validateResourceFile(Class<?> controllerClass, String resourceName) {
    ...
    if (!gui4jComponentContainer.isDefined(top)) {
      ...
      errorList.add(
          new Gui4jUncheckedException.ResourceError(
              fullyQualifiedName, 0, ErrorTags.RESOURCE_ERROR_gui4jComponent_not_defined, args));
    }
    ...
    String defaultButton =
        gui4jComponentContainer.getToplevelAttrValue(
            Gui4jComponentManager.FIELD_Gui4jViewDefaultButton);
      ...
      try {
        ...
        if (!(xc instanceof Gui4jButton)) {
          ...
          throw new Gui4jUncheckedException.ResourceError(
              fullyQualifiedName, 0, ErrorTags.RESOURCE_ERROR_invalid_defaultButton, args);
        }
      } catch (Throwable t) {
        errorList.add(t);
      }
  ...
  public int validateExistenceOfGuiIDs(
    ...
    Gui4jComponentContainer gui4jComponentContainer =
        mGui4j
            .getGui4jComponentContainerManager()
            .getGui4jComponentContainer(controllerClass, fullyQuantifiedName);
    int pos = 0;
