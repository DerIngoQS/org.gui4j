...
public class AttributeTypeEnumeration implements DefaultValueAttributeType, ParameterAttributeType {
  private final List params; // contains instances of Param
