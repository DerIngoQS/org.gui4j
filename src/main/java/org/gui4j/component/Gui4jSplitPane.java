...
public final class Gui4jSplitPane extends Gui4jJComponent {
  ...
  protected Gui4jComponentInstance createComponentInstance(
    ...
    Gui4jComponentInstance subInstance1 =
        gui4jSwingContainer.getGui4jComponentInstance(
            gui4jComponentInPath.getGui4jComponentPath(), mGui4jComponentInPath1);
    Gui4jComponentInstance subInstance2 =
        gui4jSwingContainer.getGui4jComponentInstance(
            gui4jComponentInPath.getGui4jComponentPath(), mGui4jComponentInPath2);
    ...
    Gui4jComponentInstance gui4jComponentInstance =
        new Gui4jComponentInstance(gui4jSwingContainer, splitPane, gui4jComponentInPath);
