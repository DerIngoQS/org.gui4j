...
public final class Gui4jMenu extends Gui4jMenuItem {
  ...
  public static void setWindowList(
      final JMenu menu, final Gui4jInternal gui4j, final Gui4jSwingContainer current) {
  ...
  protected static void refreshWindowList(
      JMenu menu, final Gui4jInternal gui4j, Gui4jSwingContainer current) {
    menu.removeAll();
                ...
                Gui4jGetValue action =
                    new Gui4jGetValue() {
                      public Object getValue(
                          Gui4jCallBase gui4jController, Map paramMap, Object defaultValue) {
                        window.show();
                        return null;
                      }
