...
/**
 * Base class for <code>Gui4jBoxV</code> and <code>Gui4jBoxH</code>. This class is similar to the
 * Swing LayoutManager <code>Box</code>.
 *
 * @author Joachim Schmid
 */
public abstract class Gui4jBox extends Gui4jJComponent {
  ...
  protected Gui4jComponentInstance createComponentInstance(
    ...
    Gui4jComponentInstance gui4jComponentInstance =
        new Gui4jComponentInstance(gui4jSwingContainer, container, gui4jComponentInPath);
  ...
  private boolean insertLeftGlue() {
    return Gui4jAlignment.CENTER.equals(mAlignment)
        || Gui4jAlignment.RIGHT.equals(mAlignment)
        || Gui4jAlignment.TRAILING.equals(mAlignment)
        || Gui4jAlignment.BOTTOM.equals(mAlignment);
  }

  private boolean insertRightGlue() {
    return Gui4jAlignment.CENTER.equals(mAlignment)
        || Gui4jAlignment.LEFT.equals(mAlignment)
        || Gui4jAlignment.LEADING.equals(mAlignment)
        || Gui4jAlignment.TOP.equals(mAlignment);
  }
}
