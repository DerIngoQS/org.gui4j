          ...
          public void actionPerformed(ActionEvent e) {
            Object context =
                gui4jComponentInstance
                    ...
                    .getStorage(Gui4jPopupMenu.class, Gui4jAbstractComponent.STORAGE_POPUP_CONTEXT);
            Gui4jComponentInstance origin =
                (Gui4jComponentInstance)
                    gui4jComponentInstance
                        .getGui4jSwingContainer()
                        .getStorage(
                            Gui4jPopupMenu.class, Gui4jAbstractComponent.STORAGE_POPUP_ORIGIN);
