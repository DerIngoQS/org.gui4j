...
public final class Gui4jLabel extends Gui4jJComponent {
    ...
    if (mLabelForId != null) {
      Gui4jQualifiedComponent gui4jComponentInPath =
          gui4jComponentInstance
              ...
              .getGui4jQualifiedComponent(mLabelForId);
  ...
  public void setText(Gui4jComponentInstance gui4jComponentInstance, String text) {
    if (mSuffixCall != null) {
      String suffix =
          (String) mSuffixCall.getValueNoParams(gui4jComponentInstance.getGui4jCallBase(), "");
      text = text + suffix;
    }
   ...
   * Sets the labelForId.
   *
   * @param labelForId The labelForId to set
   */
