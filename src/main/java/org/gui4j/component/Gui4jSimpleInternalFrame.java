...
public class Gui4jSimpleInternalFrame extends Gui4jJComponent {
  ...
  protected Gui4jComponentInstance createComponentInstance(
    ...
    Gui4jComponentInstance gui4jComponentInstance =
        new Gui4jComponentInstance(gui4jSwingContainer, sif, gui4jComponentInPath);
  ...
  protected void setProperties(Gui4jComponentInstance gui4jComponentInstance) {
    ...
    // set content
    Gui4jComponentInstance contentInstance =
        gui4jComponentInstance
            .getGui4jSwingContainer()
            .getGui4jComponentInstance(
                gui4jComponentInstance.getGui4jComponentInPath().getGui4jComponentPath(), content);
    sif.setContent(contentInstance.getComponent());

    // set toolbar
    if (toolbar != null) {
      Gui4jComponentInstance toolbarInstance =
          gui4jComponentInstance
              .getGui4jSwingContainer()
              .getGui4jComponentInstance(
    ...
    if (actionCommand != null) {
      Gui4jMouseListenerSimpleInternalFrame listener =
          new Gui4jMouseListenerSimpleInternalFrame(gui4jComponentInstance);
