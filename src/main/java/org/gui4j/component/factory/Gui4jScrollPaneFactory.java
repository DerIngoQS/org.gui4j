...
public final class Gui4jScrollPaneFactory extends Gui4jJComponentFactory {
  ...
  protected Gui4jJComponent defineGui4jJComponentBy(
    ...
    Gui4jScrollPane gui4jScrollPane =
        new Gui4jScrollPane(
            gui4jComponentContainer, id, gui4jComponentInPath, hScrollPolicy, vScrollPolicy);
  ...
  protected void defineProperties(Gui4jJComponent gui4jJComponent, LElement e) {
    ...
    gui4jJComponent.definePropertySetter(
        ...
        getGui4jAccessInstance(
            Border.class, new Gui4jMap1(CONTEXT, Object.class), gui4jJComponent, e, VIEWPORTBORDER),
        true);
  }
  ...
  public void addToplevelAttributes(List attrList, Filter filter) {
    ...
    if (filter == null || filter.takeIt(Gui4jScrollPaneFactory.class)) {
      ...
      attrList.add(
          new Attribute(
              HSCROLLPOLICY, new AttributeTypeEnumeration(mHScrollPolicy, AUTO), IMPLIED, false));
      attrList.add(
          new Attribute(
              VSCROLLPOLICY, new AttributeTypeEnumeration(mVScrollPolicy, AUTO), IMPLIED, false));
      attrList.add(
          new Attribute(
              VIEWPORTBORDER,
