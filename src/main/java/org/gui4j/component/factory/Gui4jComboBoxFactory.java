...
public final class Gui4jComboBoxFactory extends Gui4jJComponentFactory {
  ...
  protected Gui4jJComponent defineGui4jJComponentBy(
    ...
    Gui4jCall stringConvert =
        getGui4jAccessInstance(contentType, String.class, gui4jComboBox, e, STRINGCONVERT);
    ...
    gui4jComboBox.setManualActionOnly(
        gui4jComponentContainer.getBooleanAttrValue(e, MANUALACTIONONLY, false));

    gui4jComboBox.definePropertySetter(
        ARRAYCONTENT, getGui4jAccessInstance(Object[].class, gui4jComboBox, e, ARRAYCONTENT));
    gui4jComboBox.definePropertySetter(
        CONTENT, getGui4jAccessInstance(Collection.class, gui4jComboBox, e, CONTENT));
  ...
  public void addToplevelAttributes(List attrList, Filter filter) {
    ...
    if (filter == null || filter.takeIt(Gui4jComboBoxFactory.class)) {
      ...
      attrList.add(
          new Attribute(
              CONTENT, new AttributeTypeMethodCall(Collection.class, true), IMPLIED, false));
      attrList.add(
          new Attribute(SELECTEDITEM, new AttributeTypeMethodCall(Object.class), IMPLIED, false));
      attrList.add(
          new Attribute(EDITABLE, new AttributeTypeMethodCall(Boolean.TYPE), IMPLIED, false));
      attrList.add(new Attribute(CONTENTTYPE, new AttributeTypeAlias(), IMPLIED, false));
      attrList.add(
          new Attribute(
              ROWVALUE, new AttributeTypeMethodCall(Object.class, paramItem), IMPLIED, false));
      attrList.add(
          new Attribute(ONSELECT, new AttributeTypeMethodCall(null, paramIndex), IMPLIED, false));
      attrList.add(
          new Attribute(
              STRINGCONVERT, new AttributeTypeMethodCall(Object.class, dfltParam), IMPLIED, false));
      attrList.add(
          new Attribute(NULLITEM, new AttributeTypeMethodCall(String.class), IMPLIED, false));
      attrList.add(
          new Attribute(
              MANUALACTIONONLY,
