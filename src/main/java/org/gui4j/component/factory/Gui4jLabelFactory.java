...
public final class Gui4jLabelFactory extends Gui4jJComponentFactory {
  ...
  public void addToplevelAttributes(List attrList, Filter filter) {
    ...
    if (filter == null || filter.takeIt(Gui4jLabelFactory.class)) {
      attrList.add(
          new Attribute(TEXT, new AttributeTypeMethodCall(String.class, true), false, false));
      attrList.add(
          new Attribute(
              HALIGNMENT,
              new AttributeTypeEnumeration(Gui4jAlignment.mHorizontalAlign, Gui4jAlignment.LEADING),
              false,
              false));
      attrList.add(
          new Attribute(
      ...
      attrList.add(
          new Attribute(
              ...
              false));
      attrList.add(
          new Attribute(MNEMONIC, new AttributeTypeMethodCall(Character.TYPE), false, false));
  ...
  public Gui4jJComponent defineGui4jJComponentBy(
    ...
    gui4jLabel.definePropertySetter(
        TEXT, getGui4jAccessInstance(String.class, gui4jLabel, e, TEXT));
    gui4jLabel.definePropertySetter(
        MNEMONIC, getGui4jAccessInstance(Character.TYPE, gui4jLabel, e, MNEMONIC));
