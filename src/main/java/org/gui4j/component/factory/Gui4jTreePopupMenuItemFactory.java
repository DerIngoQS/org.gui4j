...
public class Gui4jTreePopupMenuItemFactory extends Gui4jPopupMenuItemFactory {
  ...
  protected Gui4jJComponent defineGui4jJComponentBy(
    ...
    int command =
        getMapValue(gui4jComponentContainer, e, COMMAND, mCommand, Gui4jTree.COMMAND_EXPAND);
    return new Gui4jTreePopupMenuItem(
        gui4jComponentContainer, JMenuItem.class, contextType, command, id);
  }
