...
public final class Gui4jTextAreaFactory extends Gui4jJComponentFactory {
  ...
  protected Gui4jJComponent defineGui4jJComponentBy(
    ...
    gui4jTextArea.definePropertySetter(
        TEXT, getGui4jAccessInstance(String.class, gui4jTextArea, e, TEXT));
    gui4jTextArea.definePropertySetter(
        EDITABLE, getGui4jAccessInstance(Boolean.TYPE, gui4jTextArea, e, EDITABLE));
    gui4jTextArea.definePropertySetter(
        WIDTH, getGui4jAccessInstance(Integer.TYPE, gui4jTextArea, e, WIDTH));
    ...
    gui4jTextArea.setWrapStyleWord(
        gui4jComponentContainer.getBooleanAttrValue(e, WRAPSTYLEWORD, true));
  ...
  public void addToplevelAttributes(List attrList, Filter filter) {
    ...
    if (filter == null || filter.takeIt(Gui4jTextAreaFactory.class)) {
      ...
      attrList.add(
          new Attribute(
              SETTEXT, new AttributeTypeMethodCall(null, paramsForSetText), IMPLIED, false));
      ...
      attrList.add(
          new Attribute(
              LINEWRAP, AttributeTypeEnumeration.getBooleanInstance(false), IMPLIED, false));
      attrList.add(
          new Attribute(
              WRAPSTYLEWORD, AttributeTypeEnumeration.getBooleanInstance(true), IMPLIED, false));
    }
  }
