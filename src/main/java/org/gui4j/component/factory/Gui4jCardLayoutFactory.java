...
public final class Gui4jCardLayoutFactory extends Gui4jJComponentFactory {
  ...
  protected Gui4jJComponent defineGui4jJComponentBy(
    ...
    Gui4jCardLayout gui4jCardLayout =
        new Gui4jCardLayout(gui4jComponentContainer, id, gui4jComponentDefault);
    ...
    for (Iterator it = children.iterator(); it.hasNext(); ) {
      try {
        ...
        Gui4jCall condition =
            getGui4jAccessInstance(Boolean.TYPE, gui4jCardLayout, child, CONDITION);
