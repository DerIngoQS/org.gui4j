...
public class Gui4jSimpleInternalFrameFactory extends Gui4jJComponentFactory {
  ...
  protected Gui4jJComponent defineGui4jJComponentBy(
    ...
    Gui4jSimpleInternalFrame sif =
        new Gui4jSimpleInternalFrame(gui4jComponentContainer, id, content, toolbar, selected);
  ...
  public void addToplevelAttributes(List attrList, Filter filter) {
    ...
    if (filter == null || filter.takeIt(Gui4jSimpleInternalFrameFactory.class)) {
      ...
      attrList.add(
          new Attribute(TITLE, new AttributeTypeMethodCall(String.class, true), false, false));
      attrList.add(
          new Attribute(TABTEXT, new AttributeTypeMethodCall(String.class, true), false, false));
      attrList.add(
          new Attribute(INFOTEXT, new AttributeTypeMethodCall(String.class, true), false, false));
      attrList.add(
          new Attribute(ICON, new AttributeTypeMethodCall(Icon.class, true), false, false));
      attrList.add(
          new Attribute(TABICON, new AttributeTypeMethodCall(Icon.class, true), false, false));
      attrList.add(
          new Attribute(
              SELECTED,
              new AttributeTypeEnumeration(s, Gui4jSimpleInternalFrame.SELECTED_ALWAYS),
              false,
              false));
      attrList.add(
          new Attribute(ACTION_COMMAND, new AttributeTypeMethodCall(null), IMPLIED, false));
    }
  }
