...
public abstract class Gui4jAbstractButtonFactory extends Gui4jJComponentFactory {
  ...
  public void addToplevelAttributes(List attrList, Filter filter) {
    ...
    if (filter == null || filter.takeIt(Gui4jAbstractButtonFactory.class)) {
      attrList.add(
          new Attribute(
              TEXT, new AttributeTypeMethodCall(String.class, EVENT_AWARE), IMPLIED, false));
      attrList.add(
          new Attribute(
              ACTIONCOMMAND,
              new AttributeTypeMethodCall(null, getParameterListForActionCommand()),
              IMPLIED,
              false));
      attrList.add(new Attribute(GROUP, new AttributeTypeMethodCall(String.class), IMPLIED, false));
      attrList.add(
          new Attribute(MNEMONIC, new AttributeTypeMethodCall(Character.TYPE), IMPLIED, false));
      attrList.add(
          new Attribute(
              VERTICALTEXTPOSITION,
              new AttributeTypeEnumeration(Gui4jAlignment.mVerticalAlign, Gui4jAlignment.CENTER),
              false,
              false));
      attrList.add(
          new Attribute(
              ...
              new AttributeTypeEnumeration(
                  Gui4jAlignment.mHorizontalAlign, Gui4jAlignment.TRAILING),
              false,
              false));
      attrList.add(new Attribute(ICON, new AttributeTypeMethodCall(Icon.class), IMPLIED, false));
      attrList.add(
          new Attribute(ICON_TEXT_GAP, new AttributeTypeMethodCall(Integer.TYPE), IMPLIED, false));
      attrList.add(
          new Attribute(
              SELECTED, new AttributeTypeMethodCall(Boolean.TYPE, EVENT_AWARE), IMPLIED, false));
    }
  }
  ...
  protected void definePropertyText(Gui4jAbstractComponent gui4jJComponent, LElement e) {
    gui4jJComponent.definePropertySetter(
        ...
        getGui4jAccessInstance(
            String.class,
            getParameterMapForActionCommand(gui4jJComponent),
            gui4jJComponent,
            e,
            TEXT));
  }
  ...
  protected void defineProperties(Gui4jJComponent gui4jJComponent, LElement e) {
    ...
    gui4jJComponent.definePropertySetter(
        GROUP, getGui4jAccessInstance(String.class, gui4jJComponent, e, GROUP));
    button.setActionCommand(
        getGui4jAccessInstance(
            ...
            e,
            ACTIONCOMMAND));
    button.definePropertySetter(
        MNEMONIC, getGui4jAccessInstance(Character.TYPE, gui4jJComponent, e, MNEMONIC));
    gui4jJComponent.definePropertySetter(
        ICON, getGui4jAccessInstance(Icon.class, gui4jJComponent, e, ICON));
    gui4jJComponent.definePropertySetter(
        ICON_TEXT_GAP, getGui4jAccessInstance(Integer.TYPE, gui4jJComponent, e, ICON_TEXT_GAP));
    gui4jJComponent.definePropertySetter(
        SELECTED, getGui4jAccessInstance(Boolean.TYPE, gui4jJComponent, e, SELECTED));

    {
      String hTextPosition =
          gui4jJComponent.getGui4jComponentContainer().getAttrValue(e, HORIZONTALTEXTPOSITION);
    ...
    {
      String vTextPosition =
          gui4jJComponent.getGui4jComponentContainer().getAttrValue(e, VERTICALTEXTPOSITION);
