...
public final class Gui4jListFactory extends Gui4jJComponentFactory {
  ...
  protected Gui4jJComponent defineGui4jJComponentBy(
    ...
    gui4jList.definePropertySetter(
        ARRAYCONTENT, getGui4jAccessInstance(Object[].class, gui4jList, e, ARRAYCONTENT));
    gui4jList.definePropertySetter(
        CONTENT, getGui4jAccessInstance(Collection.class, gui4jList, e, CONTENT));
    gui4jList.definePropertySetter(
        SELECTEDINDICES, getGui4jAccessInstance(int[].class, gui4jList, e, SELECTEDINDICES));

    Gui4jCall selectedItemsCall =
        getGui4jAccessInstance(Collection.class, gui4jList, e, SELECTEDITEMS);
...

    {
      ...
      gui4jList.setOnDoubleClick(
          getGui4jAccessInstance(null, paramMap, gui4jList, e, ONDOUBLECLICK));
    }
    return gui4jList;
  }
  ...
  public void addToplevelAttributes(List attrList, Filter filter) {
    ...
    if (filter == null || filter.takeIt(Gui4jListFactory.class)) {
      ...
      attrList.add(
          new Attribute(
              SELECTEDITEMS, new AttributeTypeMethodCall(Collection.class), IMPLIED, false));
      attrList.add(
      ...
      attrList.add(new Attribute(CONTENTTYPE, new AttributeTypeAlias(), IMPLIED, false));
      {
        ...
        attrList.add(
            new Attribute(
                ROWVALUE, new AttributeTypeMethodCall(Object.class, params), IMPLIED, false));
      }
      {
        List params = new ArrayList();
        params.add(new Param(Const.PARAM_ITEM));
        ...
        attrList.add(
            new Attribute(
                ONDOUBLECLICK, new AttributeTypeMethodCall(null, params), IMPLIED, false));
      }
