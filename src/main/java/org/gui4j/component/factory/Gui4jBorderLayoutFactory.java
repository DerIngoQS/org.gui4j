...
public final class Gui4jBorderLayoutFactory extends Gui4jJComponentFactory {
  ...
  protected Gui4jJComponent defineGui4jJComponentBy(
    ...
    gui4jBorderLayout.definePropertySetter(
        HSPACING, getGui4jAccessInstance(Integer.TYPE, gui4jBorderLayout, e, HSPACING));
    gui4jBorderLayout.definePropertySetter(
        VSPACING, getGui4jAccessInstance(Integer.TYPE, gui4jBorderLayout, e, VSPACING));
  ...
  public void addToplevelAttributes(List attrList, Filter filter) {
    ...
    if (filter == null || filter.takeIt(Gui4jBorderLayoutFactory.class)) {
      attrList.add(
          new Attribute(
              HSPACING, new AttributeTypeMethodCall(Integer.TYPE, EVENT_AWARE), IMPLIED, false));
      attrList.add(
          new Attribute(
              VSPACING, new AttributeTypeMethodCall(Integer.TYPE, EVENT_AWARE), IMPLIED, false));
    }
  }
}
