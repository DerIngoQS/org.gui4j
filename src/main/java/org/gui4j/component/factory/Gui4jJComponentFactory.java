...
public abstract class Gui4jJComponentFactory extends Gui4jComponentFactory {
  ...
  protected void defineProperties(Gui4jJComponent gui4jJComponent, LElement e) {
    ...
    gui4jJComponent.definePropertySetter(
        OPAQUE, getGui4jAccessInstance(Boolean.TYPE, gui4jJComponent, e, OPAQUE), false);
    gui4jJComponent.definePropertySetter(
        BORDER,
        getGui4jAccessInstance(
            Border.class, new Gui4jMap1(CONTEXT, Object.class), gui4jJComponent, e, BORDER),
        true);

    gui4jJComponent.definePropertySetter(
        TOOLTIP,
        getGui4jAccessInstance(
            String.class, new Gui4jMap1(CONTEXT, Object.class), gui4jJComponent, e, TOOLTIP),
        true);

    Gui4jCall grabFocus =
        getGui4jAccessInstance(
            null, new Gui4jMap1(CONTEXT, Object.class), gui4jJComponent, e, GRABFOCUS);
    if (grabFocus != null) {
    ...
    gui4jJComponent.setHandleReadOnly(
        handleReadOnly != null && handleReadOnly.equalsIgnoreCase("true"));
  }

  /**
   * Returns a Set of KeyStroke objects created from the specified attribute. The attribute value is
   * expected to be a comma separated list of individual KeyStroke definitions. Each definition is
   * converted to a KeyStroke using {@link KeyStroke#getKeyStroke(java.lang.String)}.
   *
  ...
  public void addToplevelAttributes(List attrList, Filter filter) {
    ...
    if (filter == null || filter.takeIt(Gui4jJComponentFactory.class)) {
      ...
      attrList.add(
          new Attribute(
              BORDER, new AttributeTypeMethodCall(Border.class, l, EVENT_AWARE), IMPLIED, false));
      attrList.add(
          new Attribute(
              TOOLTIP, new AttributeTypeMethodCall(String.class, l, EVENT_AWARE), IMPLIED, false));
      attrList.add(
          new Attribute(OPAQUE, new AttributeTypeMethodCall(Boolean.TYPE), IMPLIED, false));
      attrList.add(
          new Attribute(
              GRABFOCUS,
      ...
      attrList.add(
          new Attribute(
              HANDLE_READ_ONLY, AttributeTypeEnumeration.getBooleanInstance(), false, false));
      attrList.add(new Attribute(KEYMAP, new AttributeTypeID(), false, false));
    }
  }

  public final Gui4jComponent defineBy(
  ...
  protected abstract Gui4jJComponent defineGui4jJComponentBy(
      Gui4jComponentContainer gui4jComponentContainer, String id, LElement e);
}
