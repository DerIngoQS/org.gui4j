...
public final class Gui4jExternalComponentFactory extends Gui4jComponentFactory {
  ...
  public void addToplevelAttributes(List attrList, Filter filter) {
    ...
    if (filter == null || filter.takeIt(Gui4jExternalComponentFactory.class)) {
      attrList.add(
          new Attribute(COMPONENT, new AttributeTypeMethodCall(Component.class), REQUIRED, false));
  ...
  public Gui4jComponent defineBy(
    ...
    Map m = null;
    Gui4jCall component =
        getGui4jAccessInstance(Component.class, m, gui4jExternalComponent, e, COMPONENT);
