...
public class Gui4jEditFactory extends Gui4jJComponentFactory {
  ...
  public void addToplevelAttributes(List attrList, Filter filter) {
    ...
    if (filter == null || filter.takeIt(Gui4jEditFactory.class)) {
      attrList.add(
          new Attribute(VALUE, new AttributeTypeMethodCall(String.class, true), IMPLIED, false));
      ...
      attrList.add(
          new Attribute(
              ACTIONCOMMAND, new AttributeTypeMethodCall(null, valueParam), IMPLIED, false));
      attrList.add(
          new Attribute(SETVALUE, new AttributeTypeMethodCall(null, valueParam), IMPLIED, false));
      attrList.add(
          new Attribute(EDITABLE, new AttributeTypeMethodCall(Boolean.TYPE, true), IMPLIED, false));
      attrList.add(
          new Attribute(
              HALIGNMENT, new AttributeTypeEnumeration(mHorizontalAlign), IMPLIED, false));
    }
  }
  ...
  public Gui4jJComponent defineGui4jJComponentBy(
    ...
    gui4jEdit.definePropertySetter(
        WIDTH, getGui4jAccessInstance(Integer.TYPE, gui4jEdit, e, WIDTH));
    gui4jEdit.definePropertySetter(
        EDITABLE, getGui4jAccessInstance(Boolean.TYPE, gui4jEdit, e, EDITABLE));
  ...
  protected Gui4jEdit createTextFieldComponent(
