    ...
    for (Iterator it = mGui4jComponents.iterator(); it.hasNext(); ) {
      ...
      Gui4jComponentInstance subInstance =
          gui4jSwingContainer.getGui4jComponentInstance(
              gui4jComponentInPath.getGui4jComponentPath(), l.getGui4jComponentInPath());
      ...
      // mLogger.debug("Preferred size of placeGbl is
      // "+subInstance.getSwingComponent().getPreferredSize()+", col="+l.getGridX()+",
      // row="+l.getGridY());
