...
public final class Gui4jTableLayout extends Gui4jJComponent {
   ...
   * @param id
   */
  public Gui4jTableLayout(
      Gui4jComponentContainer gui4jComponentContainer, double[][] size, String id) {
  ...
  public void addPlacement(
      TableLayoutConstraints constraints, Gui4jQualifiedComponent gui4jQualifiedComponent) {
    ...
    for (Iterator it = mEntries.entrySet().iterator(); it.hasNext(); ) {
      ...
      Gui4jComponentInstance subInstance =
          gui4jSwingContainer.getGui4jComponentInstance(
              gui4jComponentInPath.getGui4jComponentPath(), qualifiedComponent);
