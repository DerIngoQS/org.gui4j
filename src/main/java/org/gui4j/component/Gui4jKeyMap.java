...
public class Gui4jKeyMap extends Gui4jAbstractPopupComponent {
  ...
  public void addInput(
      int focusCondition, Gui4jCall stroke, Gui4jCall action, Gui4jCall actionCommand) {
  ...
  public static void applyDefinitions(
      final Gui4jComponentInstance componentInstance, JComponent component) {
    ...
    for (Iterator it = keyMap.mList.iterator(); it.hasNext(); ) {
      ...
      if (object instanceof Gui4jAction) {
        ...
        Object actionObj =
            action.mAction.getValueNoParams(componentInstance.getGui4jCallBase(), null);
        addActionCommand(
            componentInstance.getGui4jCallBase(),
            threadManager,
            component,
      ...
      if (object instanceof String) {
        ...
        Gui4jQualifiedComponent gui4jComponentInPath =
            componentInstance
                ...
                .getGui4jQualifiedComponent(addKeyMapId);
