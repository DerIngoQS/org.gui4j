...
public class Gui4jPopupMenuItem extends Gui4jMenuItem {
  ...
  protected Gui4jActionListener createActionListener(
  ...
  protected void applyInitialProperties(
    ...
    Object context =
        swingContainer.getStorage(
            Gui4jPopupMenu.class, Gui4jAbstractComponent.STORAGE_POPUP_CONTEXT);
    if ((context == null && mContextType == null)
      ...
      if (mEnabledCall != null || mVisibleCall != null || mText != null) {
        ...
        if (mVisibleCall != null) {
          visible =
              ((Boolean) mVisibleCall.getValue(gui4jController, paramMap, Boolean.TRUE))
                  .booleanValue();
        }
        ...
        if (!visible) {
          ...
          enabled =
              ((Boolean) mEnabledCall.getValue(gui4jController, paramMap, Boolean.TRUE))
                  .booleanValue();
        }
