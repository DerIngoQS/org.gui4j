...
public abstract class Gui4jAbstractButton extends Gui4jJComponent {
   ...
   * @param id
   */
  public Gui4jAbstractButton(
      Gui4jComponentContainer gui4jComponentContainer, Class buttonClass, String id) {
  ...
  public void setGroup(Gui4jComponentInstance gui4jComponentInstance, String groupName) {
    ...
    ButtonGroup buttonGroup =
        (ButtonGroup) gui4jSwingContainer.getStorage(Gui4jAbstractButton.class, groupName);
    if (buttonGroup == null) {
