...
public interface Gui4jGetValue {
   ...
   *
   * <p>TODO: add parameter for Gui4jComponentInstance and refactor all implementors and callers.
   *
   ...
   * @return Object The result of the call or the <code>defaultValue</code> if an exception
   *     occurred.
   */
   ...
   * @return Object
   */
  Object getValueNoErrorChecking(
      Gui4jCallBase callBase, Map paramMap, Gui4jComponentInstance componentInstance);
}
