...
public interface ErrorTags {
  ...
  /** Parameters: stringValue */
  String RESOURCE_ERROR_double_DataConversionException =
  ...
  String RESOURCE_ERROR_access_value_type_not_defined =
      "resource_error_access_value_type_not_defined";

  /** Parameters: placementTag */
  String RESOURCE_ERROR_element_must_contain_gui4jComponent =
      "resource_error_element_must_contain_gui4jComponent";

  /** Parameters: id */
  String RESOURCE_ERROR_gui4jComponent_already_defined =
  ...
  /** Parameters: name */
  String RESOURCE_ERROR_gui4jComponent_not_registered =
      "resource_error_gui4jComponent_not_registered";

  /** Parameters: name */
  String RESOURCE_ERROR_gui4jComponent_already_registered =
      "resource_error_gui4jComponent_already_registered";

  /** Parameters: row, col */
  String RESOURCE_ERROR_element_at_row_col_already_defined =
  ...
  String RESOURCE_ERROR_property_getter_type_incompatible =
  ...
  /** No args */
  String RESOURCE_ERROR_attribute_listEditable_defined =
  ...
  /** Parameters: str */
  String RESOURCE_ERROR_tableLayout_invalid_col_row_str =
  ...
  /** No args */
  String PROGRAMMING_ERROR_invocation_target_exception =
