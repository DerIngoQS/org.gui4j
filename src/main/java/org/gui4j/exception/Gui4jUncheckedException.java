...
public abstract class Gui4jUncheckedException extends RuntimeException implements ErrorTags {
  ...
  protected static final Translator defaultTranslator =
      new DefaultTranslator(Locale.US, Gui4jUncheckedException.class, "errorMessages");
  ...
  public static class ResourceError extends InternalError {
    ...
    public ResourceError(
        String ressourceName, int lineNumber, String errorTag, Object[] args, Throwable e) {
