...
public interface Gui4j {
   ...
   * @return Gui4jView
   */
  Gui4jView createView(
      String viewResourceName, Gui4jController gui4jController, String title, boolean readOnlyMode);
  ...
  /** Shutdowns the framework and releases resources. */
  void shutdown();
}
